...
('office-sofa-3seater', 'Office Waiting Sofa 3-Seater', 'آفس ویسٹنگ سوفا 3 سیٹر', 'OFFICE', 'Office Sofas', 'Fabric', 'W200 x H85 x D90 cm', 'Charcoal Grey', 'Comfortable 3-seater sofa for office waiting areas. Durable fabric, plush cushions, and professional design.', ARRAY['https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?w=800'], 'FIXED', 55000, NULL, 6, 'IN_STOCK', false, true, '1 Year', ARRAY['office', 'waiting', 'sofa']),
...
('dressing-table-vanity', 'Vanity Dressing Table Set', 'وینیٹی ڈریسنگ ٹیبل', 'BEDROOM', 'Dressing Tables', 'MDF & Mirror', 'W120 x H180 x D50 cm', 'Light Oak', 'Elegant dressing table with large mirror, multiple drawers, and matching stool. Complete set.', ARRAY['https://images.pexels.com/photos/35547043/pexels-photo-35547043.jpeg?w=800'], 'FIXED', 32000, NULL, 7, 'IN_STOCK', false, true, '1 Year', ARRAY['bedroom', 'dressing', 'vanity']),
...
-- Dining (6 products)
('dining-set-6seater', '6-Seater Dining Set', '6 سیٹر ڈائننگ سیٹ', 'DINING', 'Dining Sets', 'Sheesham Wood', 'Table W180 x H75 cm', 'Natural Walnut', 'Elegant 6-seater dining set with rectangular sheesham table and matching upholstered chairs.', ARRAY['https://images.pexels.com/photos/1080721/pexels-photo-1080721.jpeg?w=800'], 'FIXED', 78000, 85000, 5, 'IN_STOCK', true, true, '2 Years', ARRAY['dining', 'set', 'sheesham', '6-seater']),
('dining-table-8-glass', '8-Seater Glass Dining Table', '8 سیٹر گلاس ڈائننگ ٹیبل', 'DINING', 'Dining Tables', 'Glass & Metal', 'W240 x H75 x D120 cm', 'Clear & Chrome', 'Modern glass dining table for 8 people. Tempered glass top with geometric chrome base.', ARRAY['https://images.pexels.com/photos/1080721/pexels-photo-1080721.jpeg?w=800'], 'INQUIRY', NULL, NULL, 0, 'MADE_TO_ORDER', false, true, NULL, ARRAY['dining', 'glass', 'modern']),
...
('extendable-dining-table', 'Extendable Dining Table', 'ایکٹینڈیبل ڈائننگ ٹیبل', 'DINING', 'Dining Tables', 'Solid Wood', 'W150-220 x H75 x D100 cm', 'Oak', 'Versatile extendable dining table. Seats 6-10 people. Perfect for entertaining.', ARRAY['https://images.pexels.com/photos/1080721/pexels-photo-1080721.jpeg?w=800'], 'FIXED', 52000, NULL, 6, 'IN_STOCK', false, true, '2 Years', ARRAY['dining', 'extendable', 'oak']),
...
('bookshelf-5tier', '5-Tier Bookshelf', '5 ٹائر بک شیلف', 'STUDY_KIDS', 'Bookshelves', 'MDF', 'W90 x H180 x D35 cm', 'Espresso', 'Open bookshelf with 5 fixed shelves. Industrial design with metal frame.', ARRAY['https://images.pexels.com/photos/35128186/pexels-photo-35128186.jpeg?w=800'], 'FIXED', 18000, NULL, 10, 'IN_STOCK', false, true, '1 Year', ARRAY['study', 'bookshelf', 'storage']),
...
('https://images.pexels.com/photos/1080721/pexels-photo-1080721.jpeg?w=800', 'DINING', 'Dining area showcase', 3),
('https://images.pexels.com/photos/5644330/pexels-photo-5644330.jpeg?w=800', 'OFFICE', 'Executive office setup', 4),
